...
```mermaid
flowchart LR
  Research[Pesquisa produtos virais] --> Content[Video faceless]
  Content --> Organic[TikTok Reels Shorts]
  Organic --> Aff[Afiliado]
  Organic --> Store[Loja propria]
  Aff -->|Oferta valida| Paid[Trafego pago]
  Store -->|Oferta valida| Paid
  Paid --> Scale[Escala]
```
